...
//ChessBoard
Point ChessBoardPoints[4];
Vector ChessBoardVectors[4];
float ChessBoardCoefficient[4] = {0,1,0,1.5};
...
int shadow_on = 0;
int ChessBoard_on = 0;
int Refractance_on = 0;
int AntiAliase_on = 0;
int Reflection_on = 0;
int InterDiffuse = 0;
// Vector BoardEdgeNorm[4] = { -1,0,0,
//                                                     0,-1,0,
//                                                    1,0,0,
//                                                    0,1,0};
...
int main( int argc, char **argv )
{
	...
	for(int i = 3; i < argc; i++)
	{
		...
		if (strcmp(argv[i], "+r") == 0)	Refractance_on = 1;
		if (strcmp(argv[i], "+p") == 0)	AntiAliase_on = 1;
		if (strcmp(argv[i], "+l") == 0)	Reflection_on = 1;
		if (strcmp(argv[i], "+f") == 0)	InterDiffuse = 1;
	}
